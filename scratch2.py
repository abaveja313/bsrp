...
def get_msdl_data():
    ...
    masker = input_data.NiftiSpheresMasker(
        seeds=coords, smoothing_fwhm=4, radius=5., memory='nilearn_cache',
        detrend=True, standardize=True, low_pass=0.1, high_pass=0.01, t_r=2.5, verbose=10)
...
def run_model(kinds, biomarkers, adhd_labels, f1=True, graph=False, report=True, c_matrix=False,
    ...
    for k in kinds:
        ...
        parameters = {
          'hidden_layer_sizes': [(64,), (int(841 ** 0.5),), (30,), (100,), (200,), (256,)],
        ...
        '''scores = cross_val_score(classifier, biomarkers[k], adhd_labels, cv=12, scoring='f1')
        print "\n"
        print "= " * 20
        print "Biomarker:", k
        print "-" * 20
